...
<label for="txtNom" class="form-label">Nombre:</label>
    ...
    <label for="txta" class="form-label">Fecha nacimiento:</label>
    <input type="date" id="txta" name="feNac" class="form-control" value="<?php echo $v['fechaNacimiento']; ?>"/>
    ...
    <label for="txtb" class="form-label">Fecha contrtación:</label>
    <input type="date" id="txtb" name="feCon" class="form-control" value="<?php echo $v['fechaContrata']; ?>"/>

    <label for="txtIdAse" class="form-label">Id Puesto:</label>
    <input type="number" id="txtIdAse" name="idPue" class="form-control" value="<?php echo $v['idPuesto']; ?>"/>

    <label for="txtIdTip" class="form-label">Id Sucursal:</label>
    <input type="number" id="txtIdTip" name="idSuc" class="form-control" value="<?php echo $v['idSucursal']; ?>"/>
</br>

<input type="hidden" name="idTrabajador" value="<?php echo $v['idTrabajador']; ?>"/></br>
