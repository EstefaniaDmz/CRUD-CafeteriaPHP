...
<form action="" method="get" class="col-12" target="_blank">
    ...
    <input type="date" id="txta" name="feNac" class="form-control"/>
    ...
    <input type="date" id="txtb" name="feCon" class="form-control"/>

    <label for="txtIdAs" class="form-label">Id Puesto:</label>
    <input type="number" id="txtIdAs" name="idPue" class="form-control"/>

    <label for="txtId" class="form-label">Id Sucursal:</label>
    <input type="number" id="txtId" name="idSuc" class="form-control"/>
